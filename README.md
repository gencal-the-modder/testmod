# Test Mod that allows user to send messages to server's inner postgres database

use "R" keybind (by default) to open screen from which you can send message to server
